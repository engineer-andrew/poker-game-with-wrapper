...
namespace CardGames.Shuffler.Logic
{
    ...
    {
        private readonly IWrapRandom _randomWrapper;

        public Shuffler(IWrapRandom randomwWrapper)
        {
            _randomWrapper = randomwWrapper;
        }
        ...
        public Deck Shuffle()
        {
            ...
            {
                var position = _randomWrapper.Next(1, 53);
